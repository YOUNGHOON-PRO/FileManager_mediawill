...
public class BulkInternalReceiveAgent extends Thread{
	
	private static final Logger LOGGER = LogManager.getLogger(BulkInternalReceiveAgent.class.getName());
	...
	public void loadProperties() {
	    ...
	    try {
	      ...
	      this.INTERVAL_TIME = Integer.parseInt(props.getProperty("RECEIVE.INTERVAL_TIME"));
	...
	public void sendOperator(OutputStream out) {
	    try {
